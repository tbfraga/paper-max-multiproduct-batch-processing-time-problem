...
$\textrm{I}_{0}$ is the initial free factory storage of product $i$ on the beginning of the (\emph{first}) planning day; 
...
$\textrm{I}_{id}$ is the maximum quantity allowed for additional factory storage of all products on day $d$;
...
\begin{equation}
P_i + UI_{i1} - D_{i1} - O_{i1} = \textrm{I}_{0} - \textrm{PO}_{i1}
\end{equation}
...
\begin{equation}
UI_{id}, O_{id}, D_{id} \in  \mathbb{Z}^+ \quad \forall i,d
\end{equation}
