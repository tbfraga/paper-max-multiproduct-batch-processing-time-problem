...
Randomly generated benchmarks were named RMBPTMP $\textrm{N}$, being $\textrm{N}$ the number of products.
...
Table X presents the results obtained by applying the analytical method and the LINGO solver for the solution of the previously presented benchmarks.
