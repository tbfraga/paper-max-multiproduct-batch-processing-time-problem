...
\cline {1-5} \\
MBPTMP 1 & 55 & 0 & 55 & 0.001 \\
MBPTMP 2 & 48 & 0.06 & 48 & 0.001 \\
MBPTMP 3 & & & 30 & 0.001 \\
RMBPTMP 20 & & & 100 & 0.001 \\
RMBPTMP 50 & & & 98 & 0.001\\
RMBPTMP 100 & & & 98 & 0.002\\
RMBPTMP 1,000 & & & 78 & 0.002\\
RMBPTMP 10,000 & & & 70 & 0.006 \\
\cline {1-5} \\
\end{tabular}
\label{tab:results}
...
The work for the elaboration of this paper is being carried out by two professors, as described below. Professor Fraga, T.B., was responsible for identifying the problem, mathematical modeling, proposing an analytical solution, developing a solver in C ++ for the analytical solution and a solver in LINGO for validating the mathematical model, developing benchmarks, and testing the analytical method and the solver in C++, as well as surveying bibliography and elaboration of the paper. Professor Menezes, R. D. C. S. is contributing to the bibliographic survey. 
